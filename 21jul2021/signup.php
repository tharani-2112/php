...
<body>
    ...
    <form class="form" method="post" enctype="multipart/form-data" name="form">
      <h5 class="heading">REGISTER HERE</h5>
        <input class="inputs" name="name" id="FirstName"   type="text" max="20" placeholder="Full Name"/><br><br>
        <input class="inputs"  name="email" id="Email" type="email" placeholder="Email address"/><br><br>
        <input class="inputs" name="mobile" id="ps1"  type="number" placeholder="Mobile number"/><br><br>
        ...
        <input name="file" class="inputs"  style="color:grey;" type="file" /><br>
